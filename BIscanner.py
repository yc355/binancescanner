...
ONE_S_PRICE_DIFFERENCE_THRESHOLD = 0.0												#1S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TEN_S_PRICE_DIFFERENCE_THRESHOLD = 0.0												#10S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIFTEEN_S_PRICE_DIFFERENCE_THRESHOLD = 0.0											#15S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TWENTY_S_PRICE_DIFFERENCE_THRESHOLD = 0.0											#20S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
THIRTY_S_PRICE_DIFFERENCE_THRESHOLD = 0.0											#30S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
ONE_M_PRICE_DIFFERENCE_THRESHOLD = 0.0												#1M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TWO_M_PRICE_DIFFERENCE_THRESHOLD = 0.0												#2M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIVE_M_PRICE_DIFFERENCE_THRESHOLD = 0.0												#5M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TEN_M_PRICE_DIFFERENCE_THRESHOLD = 0.0												#10M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIFTEEN_M_PRICE_DIFFERENCE_THRESHOLD = 0.0											#15M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
...
if configs['CHANGE_PCT']:
	ONE_S_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#1S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	TEN_S_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#10S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	FIFTEEN_S_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']											#15S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	TWENTY_S_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']											#20S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	THIRTY_S_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']											#30S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	ONE_M_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#1M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	TWO_M_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#2M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	FIVE_M_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#5M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	TEN_M_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']												#10M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
	FIFTEEN_M_PRICE_DIFFERENCE_THRESHOLD = configs['CHANGE_PCT_MIN']	
...
def printOutput(flag=None, sym=None, diff=None, data=None):
	if configs['MINUTELY_AVG_DOLLAR_VOLUME'] and latest_btc_price:
		current_time = round(time.time() * 1000)
		min_candles = client.get_historical_klines(
			symbol=sym, 
			interval=Client.KLINE_INTERVAL_1MINUTE, 
			start_str=int(current_time - 60_000 * configs['MINUTELY_AVG_DOLLAR_VOLUME_LOOKBACK']), 
			end_str=current_time
		)
		vol_sum = 0
		for c in min_candles:
			vol_sum += float(c[5])
		if not(configs['MINUTELY_AVG_DOLLAR_VOLUME_MIN'] <= vol_sum / len(min_candles) * data.bid_price * latest_btc_price <= configs['MINUTELY_AVG_DOLLAR_VOLUME_MAX']):
			return
