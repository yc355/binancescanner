...
TEN_S_PRICE_DIFFERENCE_THRESHOLD = 1.0												#10S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIFTEEN_S_PRICE_DIFFERENCE_THRESHOLD = 1.0											#15S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TWENTY_S_PRICE_DIFFERENCE_THRESHOLD = 1.0											#20S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
THIRTY_S_PRICE_DIFFERENCE_THRESHOLD = 1.0											#30S PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
ONE_M_PRICE_DIFFERENCE_THRESHOLD = 1.0												#1M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TWO_M_PRICE_DIFFERENCE_THRESHOLD = 1.0												#2M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIVE_M_PRICE_DIFFERENCE_THRESHOLD = 1.0												#5M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
TEN_M_PRICE_DIFFERENCE_THRESHOLD = 1.0												#10M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
FIFTEEN_M_PRICE_DIFFERENCE_THRESHOLD = 1.0											#15M PRICE DIFFERENCE IN PERCENTAGE THRESHOLD
